...
if($fil == 'all')
{
	$bil = $conn->query("SELECT * FROM us_billentry WHERE user_id='".$_SESSION["admin"]."' and finyear = '".$_SESSION["finyearid"]."' AND be_isactive='0' AND be_mod='2' ORDER BY be_billid DESC");
