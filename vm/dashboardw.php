		...
		if($insrtbill)
		{
			...
			if($discount >0){
				...
				switch($billtype)
				{
					...
					header('Location: dashboardw.php?er=error1');
			}
			}
			else{
				//echo $sql1;
			...
			header('Location: dashboardw.php?er=error');
			//echo print_r($_POST);
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
				...
				if(isset($_GET['billno']))
				{
					...
					$stocks = $conn->query("SELECT * FROM us_billentry WHERE user_id='".$_SESSION["admin"]."' and finyear = '".$_SESSION["finyearid"]."' AND be_mod='2' ORDER BY be_billid DESC LIMIT 1");
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    ...
                                    <a href="dashboardw.php?billno=<?= $billno+1 ?>" target="_blank"><button type="button" class="btn btn-primary btn-addon m-b-sm" style="float:right"><i class="fa fa-plus"></i> Another Bill</button></a>
									...
									<a href="dashboard.php" ><button type="button"  class="btn btn-primary btn-addon m-b-sm" style="float: right;margin-right:13px;"><i class="fa fa-plus"></i>RETAIL</button></a>
                                </div>
                                <?php
								if(isset($_GET['id']))
								{
                                ...
                                <div class="panel-body">
                                    <div class="project-stats">  
                                       ...
                                       <table class="table" id="drag">
                                       	<tr>
                                        	<td>
                                            Bill No: <b> ABI/KE/<input type="text"  name="billno" id="billno" value=" <?= $billno ?>" style="width:50px;border: 0;font-size: 20px;background: white">/1819<br><br>
...
function addproductdetais(srchky, num)
{
	...
	var tot = Number(saleprice)+Number(vtamnt);
