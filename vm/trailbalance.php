                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            ?>
                                ...
                                $todate = $_POST['todate'];
                                                  ...
                                                  $bil = $conn->query("SELECT *,sum(dayBookAmount) as amnt,sum(bill_amnt) as billamnt FROM administrator_daybook where DATE(dayBookDate)>='$fromdate' AND DATE(dayBookDate) <= '$todate' AND finyear = '".$_SESSION["finyearid"]."'  and mode='1'   and dr_cr='D' Group BY debit ORDER BY refid ");

                                                 $bils = $conn->query("SELECT *,sum(dayBookAmount) as amnt,sum(bill_amnt) as billamnt FROM administrator_daybook where DATE(dayBookDate)>='$fromdate' AND DATE(dayBookDate) <= '$todate' AND finyear = '".$_SESSION["finyearid"]."' and mode='1'  and dr_cr='C' Group BY credit ORDER BY refid");
                                                ...
                                                $bil = $conn->query("SELECT *,sum(dayBookAmount) as amnt,sum(bill_amnt) as billamnt FROM administrator_daybook where  finyear = '".$_SESSION["finyearid"]."'  and mode='1'   and dr_cr='D' Group BY debit ORDER BY refid ");

                                                 $bils = $conn->query("SELECT *,sum(dayBookAmount) as amnt,sum(bill_amnt) as billamnt FROM administrator_daybook where  finyear = '".$_SESSION["finyearid"]."' and mode='1'  and dr_cr='C' Group BY credit ORDER BY refid");
                                                 $open = $conn->query("SELECT * FROM administrator_account_name where refid='1' ");
                                ...
                                ?>
                                    <div class="table-responsive project-stats">  
                                      <BR><BR>
                                      <!--<form action="trailbalance.php" method="post">
