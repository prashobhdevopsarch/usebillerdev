...
if(isset($_SESSION['admin']))
{
	...
	if(isset($_POST['update']))
	{
		...
		$updte = $conn->query("UPDATE us_shopprofile SET sp_shopname='$name', sp_shopaddress='$address', sp_phone='$phone', sp_mobile='$mobile', sp_email='$email', sp_vatreadymades='$vat', sp_vatmillgoods='$vat1', sp_tin='$tin_number' WHERE sp_shopid='$shopid'");
		if($updte)
		{
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
										...
										<a href= "stocks.php">
                                        <span class="info-box-title">Stocks</span></a>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
										...
										<a href= "outofstocks.php">
                                        <span class="info-box-title">Out of Stocks</span></a>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="fa fa-list-alt" aria-hidden="true"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Total Bills</span><a>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
										...
										<a href="billinghistory.php">
                                        <span class="info-box-title">Today Bills</span></a>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="fa fa-print" aria-hidden="true"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
										...
										<a href="cushistory.php">
                                        <span class="info-box-title">Total customers</span></a>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
										...
										<a href="cushistory.php">
                                        <span class="info-box-title">Customer Balance</span><a>
                                    </div>
                                    <div class="info-box-icon">
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">Supplier Balance</span></a>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="fa fa-inr" aria-hidden="true"></i>
                                    </div>
