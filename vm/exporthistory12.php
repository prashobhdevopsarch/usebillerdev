...
if($fil == 'all')
{
	$bil = $conn->query("SELECT * FROM us_performo WHERE user_id='".$_SESSION["admin"]."' and finyear = '".$_SESSION["finyearid"]."' AND pe_isactive='0' AND pe_mod='1' ORDER BY pe_billid DESC");
                                           ...
                                           <tbody>
                                               ...
                                               <tr style="font-size:14px;">
                                                   ...
                                                   <td>
													...
													{
														echo $n . ". " .$row2['pr_productname'] . ", <b>Unit Price:</b>" . $row2['pe_price'] . ", <b>Qty:</b>" . $row2['pe_quantity'] . ", <b>Total:</b>" . $row2['pe_total'] . "<br/>";
														$n++;
													}
													?>
                                                   </td>
