...
if(isset($_SESSION['admin']))
{
	...
	if(isset($_POST['submit']))
	{
		...
		$insert = $conn->query("INSERT INTO us_addemployee(us_employeeid, us_employeename, us_password, us_employeeaddress, us_employeeemail,user_id) VALUES('$csid','$name','$password','$address','$email','".$_SESSION["admin"]."')");
		if($insert)
		{
			header('Location:employeehis.php?id=success');
	  }
	  else{
		  header('Location:employeehis.php?id=fail');
		}
	}
?>
<!DOCTYPE html>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>Add employees</strong></h3>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Add employee Details</h4>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-3 control-label">Employee Name</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="employeename" value="" id="employeename" placeholder="employee Name" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
