...
<table style="text-align:left;" width="100%" border="0">
  <tr>
	...
	Customer Name : <?= $rowcus['cs_customername'] ?></td>
...
if($fil == 'all')
{
	$bil = $conn->query("SELECT * FROM us_billentry WHERE be_customerid='$customerid' AND user_id='".$_SESSION["admin"]."' AND be_isactive='0' ORDER BY be_billid DESC");
	...
	$bil = $conn->query("SELECT * FROM us_billentry WHERE be_customerid='$customerid' AND DATE(be_billdate)>='$fromdate' AND DATE(be_billdate) <= '$todate' AND be_isactive='0' AND user_id='".$_SESSION["admin"]."' ORDER BY be_billid DESC");
