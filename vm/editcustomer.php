...
if(isset($_SESSION['admin']))
{
	...
	if(isset($_POST['submit']))
	{
		...
		$update = $conn->query("UPDATE us_customer SET cs_customername='$name', cs_customerphone='$phone', cs_address='$address', cs_email='$email', cs_balance='$balance', cs_tin_number='$tin_number', cs_statecode='$statecode' WHERE cs_customerid='$csid'");
		if($update)
		{
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
								...
								$today = date('Y-m-d');
								$cusid=$_GET["cusid"];
								$cus = $conn->query("SELECT * FROM us_customer WHERE user_id='".$_SESSION["admin"]."' AND cs_customerid='$cusid' AND cs_isactive='0'");
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="name" value="<?=$row["cs_customername"]?>" id="customer_name" placeholder="Customer Name" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-help-block" class="col-sm-3 control-label">Phone Number</label>
                                            <div class="col-sm-9">
                                                <input type="text"  class="form-control" value="<?=$row["cs_customerphone"]?>" name="phone"  id="cutomer_phone" placeholder="Phone Number">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="address"  id="customer_address" placeholder="Address"><?=$row["cs_address"]?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control" name="email" value="<?=$row["cs_email"]?>" id="customer_email" Placeholder="Email ID">
