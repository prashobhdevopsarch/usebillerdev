                                ...
                                <div class="panel-body">
                                    ...
                                    <tbody><?php
                                      ...
                                      <input type="hidden" name="prodid[]" id="prodid<?= $k ?>">
										...
										<td style="display:none;"><input type="number" step="any"  readonly placeholder="Unit Price" style="width:100px;" class="form-control" name="purchaseprice[]"  id="unitprice<?= $k ?>"></td>
                                        <td>
