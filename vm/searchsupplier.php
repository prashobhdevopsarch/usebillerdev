...
$key = $_GET['key'];
$search = $conn->query("select * from us_supplier where user_id='".$_SESSION["admin"]."' AND ( rs_company_name like '".$key."%' OR rs_name like '".$key."%') order by 	rs_company_name asc  limit 10");
