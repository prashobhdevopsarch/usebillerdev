        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>Purchase TAX</strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>Billing</li>
							<li>Tax Report</li>
                            <li class="active">Purchase TAX</li>
                        </ol>
                    </div>
                </div>
                <?php
                        ...
                        <div class="col-lg-12 col-md-12">
							...
							?>
                                <div class="panel-heading">
                                	<a href="exportpDB.php?fil=<?= $filt ?>" target="_blank"><button type="button" class="btn btn-primary btn-addon m-b-sm" style="float:right;margin-left: 5px;"><span class="glyphicon glyphicon-print"></span> Export(TAX%)</button></a><a href="exportpDB_item.php?fil=<?= $filt ?>" target="_blank"><button type="button" class="btn btn-primary btn-addon m-b-sm" style="float:right;margin-left: 5px;"><span class="glyphicon glyphicon-print"></span> Export(Item)</button></a>
                                    <h4 class="panel-title">Purchase TAX Report</h4>
                                </div>
                                
                                
                                <div class="panel-body">
                                <form action="puchasevat.php" method="post">
								...
								if(isset($_POST['filter']))
											   {
											   	...
											   	$bil = $conn->query("SELECT * FROM us_purentry WHERE pe_isactive='0' AND user_id='".$_SESSION["admin"]."' and finyear = '".$_SESSION["finyearid"]."' ORDER BY pe_billid DESC");
												echo "<h3>ALL PURCHASE TAX DETAILS</h3>";
											   }
								?>
                                       ...
                                       <table id="example" class="display table" style="width: 90%; cellspacing: 0;">
                                           <thead>
                                               <tr>
												   ...
												   <th colspan="3" style="text-align:center">GST Purchase</th>
                                           ...
                                           <tbody>
                                               ...
                                               <tr>
                                                   ...
                                                   <td align="right">
													...
													$itms = $conn->query("SELECT SUM(pi_cgstamt) AS cgst,SUM(pi_sgstamt) AS sgst,SUM(pi_igstamt) AS igst FROM us_puritems WHERE pi_billid='$billid'");
													$n=0;
												   ...
												   <?php
													$billid = $row['pe_billid'];
													$itms = $conn->query("SELECT SUM(pr_cgstamt) AS cgst,SUM(pri_sgstamt) AS sgst,SUM(pri_igstamt) AS igst FROM us_purreturnitem WHERE pri_returnbillid='$billid'");
													$n=0;
													if($row2 = $itms->fetch_assoc())
													{
														$n1=$row2['cgst'];
