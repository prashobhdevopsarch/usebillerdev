...
<table style="text-align:left;" width=100% border="1">
    ...
    <th style="text-align:center; font-size:24px; border-left:hidden; border-right:hidden; border-top:hidden;" colspan="2">PAYMENT RECIEPT</th>
    ...
    <table >
    <tr><td style="text-align:left">Payment By:&nbsp; <?=$row1["tr_particulars"]?></td></tr>
    <tr><td style="text-align:left"> To:&nbsp; <?=$row1["tr_name"]?></td></tr>
    <tr><td style="text-align:left">Note:&nbsp; <?=$row1["tr_transactiontype"]?></td></tr>
  
  
  <tr><td></td></tr>
  <tr><td >Amount of Reciept:&nbsp;<?=$row1["tr_transactionamount"]?> Rs.</td>
