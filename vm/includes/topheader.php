                ...
                <div class="navbar-inner">
                    ...
                    <div class="topmenu-outer">
                        <div class="top-menu">
                            ...
                            <?php
						//include("config.php");
						$slct_shop=$conn->query("SELECT * FROM us_shopprofile WHERE sp_shopid='".$_SESSION['admin']."'");
                        ...
                        <span style="width:100%">Activate Your Account</span><br /><span style="width:100%">trial ends in <?=$endtrail?> day</span>
                           ...
                           <?php }?>
                            <ul class="nav navbar-nav navbar-right">
                             ...
                             <li>
                                    <a href="http://utparasolutions.com/contact.php" target="_blank" class="log-out waves-effect waves-button waves-classic">
                                        <span>For Complaint</span>
                                    </a>
                                </li>
								
								 <li>
                                    <a href="https://ewaybillgst.gov.in/login.aspx" target="_blank" class="log-out waves-effect waves-button waves-classic">
                                        <span>For E-Way Billing</span>
                                    </a>
                                </li>
