...
if(isset($_SESSION['admin']))
{
	...
	{
		$bill_id=$_GET["billid"];
		$delete=$conn->query("UPDATE us_estimation SET be_isactive='1' WHERE be_billid='$bill_id'");
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>Estimation History</strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>Billing</li>
                            <li class="active">Estimation History</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12 col-md-12">
							...
							?>
                                <div class="panel-heading">
                                	<a href="exportestimate.php?fil=<?= $filt ?>" target="_blank"><button type="button" class="btn btn-primary btn-addon m-b-sm" style="float:right;"><span class="glyphicon glyphicon-print"></span> Print</button></a>
                                    <h4 class="panel-title">Estimation History</h4>
                                </div>
                                
                                
                                <div class="panel-body">
                                <form action="estimationhistory.php" method="post">
								...
								if(isset($_POST['filter']))
											   {
												   $fromdate = $_POST['fromdate'];
												   $todate = $_POST['todate'];
												   $bil = $conn->query("SELECT * FROM us_estimation WHERE DATE(be_billdate)>='$fromdate' AND DATE(be_billdate) <= '$todate' AND be_isactive='0' AND user_id='".$_SESSION["admin"]."' and finyear = '".$_SESSION["finyearid"]."' ORDER BY be_billid DESC");
												   echo "<h3>From Date: ".date('d-M-Y', strtotime($fromdate))." &nbsp; &nbsp; To Date: ".date('d-M-Y', strtotime($todate))."</h3>";
											   }
											   else{
											   	$bil = $conn->query("SELECT * FROM us_estimation WHERE be_isactive='0' AND user_id='".$_SESSION["admin"]."' and finyear = '".$_SESSION["finyearid"]."' ORDER BY be_billid DESC");
												echo "<h3>ALL BILL DETAILS</h3>";
											   }
								?>
                                    <div class="table-responsive project-stats">  
                                    <form class="form-horizontal" method="post" action="exportestimate1.php?fil=<?= $filt ?>">
                                           ...
                                           <tbody>
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
													...
													$itms = $conn->query("SELECT * FROM us_estimationitems a LEFT JOIN us_products b ON b.pr_productid=a.bi_productid WHERE a.bi_billid='$billid'");
													$n=1;
                                                 ...
                                                 <a onClick="return confirm('Are you sure you want to delete?')" href="estimationhistory.php?billid=<?=$row['be_billid']?>&delete"><span class="glyphicon glyphicon-trash"></span> delete</a>
                                                   </td>
                                               </tr>
