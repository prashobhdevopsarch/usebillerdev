...
<table style="text-align: left; border-color:#000;" width="100%" border="1">
   <tr border="1" >
    <td  style="padding:5px;width:50%; border-left:1px solid #000;font-size: 12px;">
    ...
    <td  style="padding:5px;width:50%; border-left:1px solid #000;font-size: 12px;">Transportation Mode:<br>
...
<table border="1" width="100%" class="table">
	<tr>
    	<td style="text-align:center;width: 50%; border-left:1px solid #000;font-size: 14px;">Details Of Reciever (Billed To)</td>
        <td style="text-align:center;width: 50%; border-left:1px solid #000;font-size: 14px;">Details Of Consignee</td>
	</tr>
    <tr>
   
    	<td style="padding:5px; border-left:1px solid #000;font-size: 12px;"> <?php if ($row4["be_customerid"] == "0") {
    	?>
        Name:
        <b><?php
...
<td align="center"><?php echo $amt;?></td>
    ...
    <td align="center"><?php echo $totalbi1;?></td>
</tr>
</table>
<?php if($r==$ttl){?>
...
<span class="s8">Rupees: <?php $amd=convert_number_to_words(round($totalbi1));echo $amd;?> Only</span>
</td>
...
<tr>
<td colspan="2" rowspan="3" style="border-bottom:1px solid #000;">
...
<tr>
<td style="border-bottom:1px solid #000;" colspan="2"><b>Invoice Total(Rs)</b></td><td style="border-bottom:1px solid #000;" colspan="2"><b><?= round($totalbi1+$row4["be_coolie"]);?></b></td>
</tr>
