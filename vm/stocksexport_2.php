...
$output .="\n";
$output .='No.,Product Code,Product Name,HSN Code,Tax,Unit,Purchase price,Sales price,Stock';
$output .="\n";
...
$output .=$k.','.$row['pr_productcode'].','.$row['pr_productname'].','.$row['pr_hsn'].','.$row['ca_categoryname'].','.$row['pr_unit'].','.$row['pr_purchaseprice'].','.$row['pr_saleprice'].','.$row['pr_stock'].',';
