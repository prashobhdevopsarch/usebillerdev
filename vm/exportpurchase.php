...
$output .='No.,Bill No.,Bill Date,State Code,supplier invoice NO:,Items,Quantity,Purchase Price,Total,Total Discount,Grand Total,';
...
$output .=$k.','.$row['pe_billnumber'].','.date('d-M-Y H:i', strtotime($row['pe_billdate'])).','.$row['pe_statecode'].','.$row['pe_invoice_number'].',';
