        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>STATEMENT VIEW</strong></h3>
                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            ?>
                                <div class="panel-heading">
                                    ...
                                    <h4 class="panel-title">STATEMENT VIEW </h4>
                                </div>
 ...
 <?php
                                               ...
                                               <tr>
                                                   ...
                                                   <td> <?php
                                                        ...
                                                        $grp = $conn->query("SELECT * FROM us_transaction where tr_accid='".$row['refid']."' ");
                                                       $rowv = $grp->fetch_assoc();
                                                    
                                                       echo "bbb ".$rowv['rpt_no']." ";
