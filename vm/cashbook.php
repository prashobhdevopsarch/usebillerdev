                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            ?>
                                ...
                                $todate = $_POST['todate'];
                                                  ...
                                                  $bil = $conn->query("SELECT *,sum(dayBookAmount) as amount FROM administrator_daybook where  DATE(dayBookDate)>='$fromdate' AND DATE(dayBookDate) <= '$todate' AND finyear = '".$_SESSION["finyearid"]."' and mode='1' and dr_cr='D' AND credit='1' group by debit ");

                                                 $bils = $conn->query("SELECT *,sum(dayBookAmount) as amount FROM administrator_daybook where DATE(dayBookDate)>='$fromdate' AND DATE(dayBookDate) <= '$todate' AND  finyear = '".$_SESSION["finyearid"]."' and mode='1' and dr_cr='C' and debit='1' group by credit");



                                                       $ldg = $conn->query("SELECT * FROM administrator_account_name where refid='1' ");
                                                ...
                                                $bil = $conn->query("SELECT *,sum(dayBookAmount) as amount FROM administrator_daybook where  finyear = '".$_SESSION["finyearid"]."' and mode='1' and dr_cr='D' AND credit='1' group by debit  ");

                                                 $bils = $conn->query("SELECT *,sum(dayBookAmount) as amount FROM administrator_daybook where  finyear = '".$_SESSION["finyearid"]."' and mode='1' and dr_cr='C' and debit='1' group by credit");
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                      <?php
                                                       ...
                                                       echo $rows['amount'];
                                                     $credittot=$credittot+$rows['amount'];
