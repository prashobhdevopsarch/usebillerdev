	...
	if(isset($_POST['submit']))
	{
		...
		$con_password=$_POST['con_password'];
			...
			if($newpassword==$con_password)
			{
					...
					$st=$conn->query("SELECT * FROM us_shopprofile WHERE sp_username='$username' AND sp_password='$password' AND sp_shopid='$shopid'");
					if($st->num_rows>0)
					{
					
						$st=$conn->query("UPDATE us_shopprofile SET sp_password='$newpassword' WHERE sp_shopid='".$_SESSION['admin']."'" );
...
if(isset($_POST['submituser']))
	{
		...
		$st=$conn->query("SELECT * FROM us_shopprofile WHERE sp_username='$username' AND sp_password='$password' AND sp_shopid='$shopid'");
					if($st->num_rows>0)
					{
						...
						$st=$conn->query("SELECT * FROM us_shopprofile WHERE sp_username='$n_username'");
						if($st->num_rows>0)
						{
						...
						{
							$st=$conn->query("UPDATE us_shopprofile SET sp_username='$n_username' WHERE sp_shopid='".$_SESSION['admin']."'" );
