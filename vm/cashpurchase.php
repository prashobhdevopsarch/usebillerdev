...
$deletst=$conn->query("DELETE FROM us_stockreport WHERE billid='".$bill_id."' and sr_mode='Purchase'");
      ...
      $cusbal=$conn->query("UPDATE us_supplier SET rs_balance='$realoldbal' WHERE rs_supplierid='$supid'");
			...
			{
			header('Location:cashpurchase.php?id=success');
			}
		}else{
		  header('Location:cashpurchase.php?id=fail');
		}
	}
?>
<!DOCTYPE html>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>Cash Purchase History</strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>Billing</li>
                            <li class="active">Cash Purchase History</li>
                        </ol>
                    </div>
                </div>
                <?php
                        ...
                        <div class="col-lg-12 col-md-12">
							...
							?>
                                <div class="panel-heading">
                                	<a href="exporthistorypcash.php?fil=<?= $filt ?>" target="_blank"><button type="button" class="btn btn-primary btn-addon m-b-sm" style="float:right;"><span class="glyphicon glyphicon-print"></span> Print</button></a>
                                ...
                                <form action="cashpurchase.php" method="post">
								...
								?>
                                    ...
                                    <form class="form-horizontal" method="post" action="exportpurchasecash.php?fil=<?= $filt ?>">
                                           ...
                                           <tbody>
                                               ...
                                               <tr>
                                                   ...
                                                   <td><?php
													   ...
													   ?></td>
                                                   <td><?php $slcsup=$conn->query("SELECT * FROM us_purentry WHERE user_id='".$_SESSION["admin"]."' AND pe_billid='$billid' and pe_balance='0' AND pe_isactive='0'");
                                                  ...
                                                  <a onClick="return confirm('Are you sure you want to delete?')" href="cashpurchase.php?billid=<?=$row['pe_billid']?>&delete&supid=<?=$rowsup1['pe_supplierid']?>&oldbal=<?=$row['rs_balance']?>"><span class="glyphicon glyphicon-trash"> <br></span> delete</a>
                                                   </td>
                                               </tr>
