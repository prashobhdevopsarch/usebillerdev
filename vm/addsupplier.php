...
if(isset($_SESSION['admin']))
{
	...
	if(isset($_POST['submit']))
	{
		...
		$acntname=strtoupper($company_name." ".$supplier_name);
		
		$insrtacnt=$conn->query("INSERT INTO administrator_account_name(acc_name, acc_head, group_head, other_details, act_group_head, opening_balance, opening_balance_type, closing_balance, acc_updatedtime, acnt_branch,finyear,user_id) VALUE('$acntname','bs','liability','$acntname','1','$balance','debit','0',NOW(),'".$_SESSION['admin']."','".$_SESSION["finyearid"]."','".$_SESSION['admin']."')");
		$acnt_id=$conn->insert_id;
		//echo print_r($_POST);
		$insert = $conn->query("INSERT INTO us_supplier(rs_company_name, rs_name, rs_phone, rs_address, rs_email, user_id, rs_balance, rs_tinnum, rs_statecode,rs_acntid) VALUES('$company_name','$supplier_name','$supplier_phone','$supplier_address','$supplier_email','".$_SESSION["admin"]."', '$balance', '$tin_number', '$statecode','$acnt_id')");
		if($insert)
		{
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Add Supplier Details</h4>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="supplier_name" value="" id="supplier_name" placeholder="Supplier Name" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-help-block" class="col-sm-3 control-label">Phone Number</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="supplier_phone"  id="supplier_phone" placeholder="Phone Number">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="supplier_address" value="" id="supplier_address" placeholder="Address"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control" name="supplier_email" value="" id="supplier_email" Placeholder="Email ID">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="tect" class="form-control" name="tin_number" value="" id="tin_number" Placeholder="GSTIN">
