                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <tbody><?php
                                        ...
                                        <td>
                                        <input type="text" onKeyPress="(<?= $k ?>)" onkeydown="if (event.keyCode == 13 || event.keyCode == 9){$('#vatper<?= $k ?>').focus();}" onBlur="addproductdetais_name(this.value, <?= $k ?>)" autocomplete="off" class="form-control" name="productmlname[]" id="productmlname<?= $k ?>" style="width:200px;" placeholder="Product Name" value="<?=$itmrow["pr_productname"]?>" ></td>
                                        ...
                                        <td>
                                        <input type="text" placeholder="GST %" style="width:60px;" value="<?=$rowitm["bi_vatper"]?>" class="form-control" name="vatper[]" id="vatper<?= $k ?>"></td>
                                       ...
                                       Avail Stock: <span id="availableqty<?= $k ?>"></span> Balance: <span id="bal<?=$k?>"></span>
										...
										?>
                                        <td><input type="text" style="width:60px;" class="form-control" onChange="calcdisc(this.value,<?= $k ?>)" name="discounti[]"  value="<?=$rowitm["bi_discount"]?>" id="discount<?= $k ?>"><input type="hidden" name="prediscount[]" value="<?=$disc?>" id="prediscount<?= $k ?>"></td>
                                        </td>
