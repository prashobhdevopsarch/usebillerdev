                 ...
                 <!---      <div class="panel-body">
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="page-breadcrumb">
                                    	...
                                    	<a href="jurnel.php"><button type="button" class="btn btn-primary btn-addon m-b-sm" style="float:right">Journal</button></a>
                                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <ol class="breadcrumb">
							...
							<td style="width:124px;"><select name="name" style="width: 136px;" id="name<?= $k ?>" class="form-control">
													...
													$sql1="SELECT acc_name FROM administrator_account_name WHERE user_id ='".$_SESSION["admin"]."' " ;
													$sql= $conn->query("$sql1");
									...
									<td style="width:124px;"><select style="width: 136px;" name="particulars"  class="form-control">
													...
													$sql2="SELECT acc_name FROM administrator_account_name WHERE user_id ='".$_SESSION["admin"]."' " ;
