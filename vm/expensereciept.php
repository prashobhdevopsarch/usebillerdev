...
//        $row5 = $cust->fetch_assoc();
     ...
     <span class="s4">GSTIN : <?= $row3["sp_tin"] ?><br>
                        <br>
                        <span class="s3" ><b>PAYMENT RECIEPT</b></span>
        ...
        <table style="border-bottom: 1px #808080 solid;" width="100%" border="0" cell >
            ...
            <tr  rowspan="2"><td style="text-align:left">&nbsp;&nbsp;Reciept No:&nbsp; <?= $row1["rpt_no"] ?></td><td  style="text-align:right">Dated As:&nbsp;<?=$row1["tr_date"]?>&nbsp;&nbsp;</td></tr>
             <?php
            $slct = $conn->query("SELECT acc_name FROM administrator_account_name WHERE refid='" . $row1["tr_particulars"] . "'");
            $row3 = $slct->fetch_assoc();
            ?>
             <tr  ><td  colspan="2">&nbsp;&nbsp;</td></tr>
            <tr><td colspan="1" style="text-align:left">&nbsp;&nbsp;Cash Received From :&nbsp;<?= $row3["acc_name"] ?> </td><td>Amount :&nbsp;<?= $row1["tr_transactionamount"] ?></td></tr>
             <tr  ><td  colspan="2">&nbsp;&nbsp;</td></tr>
 ...
 <tr  ><td  colspan="2">&nbsp;&nbsp;</td></tr>
   <tr  ><td  colspan="2">&nbsp;&nbsp;</td></tr>
    ...
    <tr  ><td style="text-align:right"  colspan="2">Signature</td></tr>
