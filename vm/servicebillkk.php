...
if(isset($_SESSION['admin']))
{
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="INSERT INTO us_ser(se_billnumber,se_customerid, se_customername, se_customermobile, se_deliverydate, se_saleperson, se_billdate, user_id, se_vehicle_number, se_address, se_shipping, finyear) VALUES('$billno','$customer', '$customername', '$phone', '$delivery_date', '$sales_person','$curdate','$".$_SESSION["admin"]."','$vehicle_number', '$address', '$shipping_address', '".$_SESSION["finyearid"]."')";
			...
			foreach($prodid as $prdval)
			{
				if($prdval != "")
				{
                   if($supplyplace==$_SESSION["stcode"])
					...
					$insrtitms = $conn->query("INSERT INTO us_seritem(se_billid, se_item, se_com) VALUES('$bill_id', '$itemname', '$comp')");
...
<!-- 										   <br> <input type="text" class="form-control" name="electrician" style="width: 220px; display: inline;" id="electrician" onKeyPress="autoele()" placeholder="Eletrician Name" onBlur="addelec(this.value)" > &nbsp; 
                                            ...
                                            <input type="text" class="form-control" name="phone" style="width: 220px; display: inline;" id="phone" placeholder="Phone Number">
                                                ...
                                                <b>Expected delivery:</b> <input type="date" class="form-control" name="deliverydate" style="width: 220px; display: inline;" id="deliverydate" placeholder="deliverydate">    
                                            ...
                                            <input type="text" class="form-control" name="vehicle_number" style="width: 220px; display: inline;margin-top: 15px;" id="vehicle_number" placeholder="Vehicle Number">
                                                ...
                                                <input type="text" class="form-control" name="shippingAdd" style="width: 220px; display: inline;" id="shippingAdd" placeholder="Delivery Address">
