...
<title>Supplier Bill History</title>
</head>
...
<table style="text-align:left;" width="100%" border="0">
  <tr>
    <td><h4><?= $row3['sp_shopname'] ?></h4><BR>
	Customer Name : <?= $rowcus['rs_company_name'] ?></td>
...
if($fil == 'all')
{
	$bil = $conn->query("SELECT * FROM us_purentry WHERE pe_supplierid='$supid' AND user_id='".$_SESSION["admin"]."' AND pe_isactive='0' ORDER BY pe_billid DESC");
	...
	$bil = $conn->query("SELECT * FROM us_purentry WHERE pe_supplierid='$supid' AND DATE(pe_billdate)>='$fromdate' AND DATE(pe_billdate) <= '$todate' AND pe_isactive='0' AND user_id='".$_SESSION["admin"]."' ORDER BY pe_billid DESC");
                                           ...
                                           <tbody>
                                               ...
                                               <tr style="font-size:14px;">
                                                   ...
                                                   <td>
													...
													{
														echo $n . ". " .$row2['pr_productname'] . ", <b>Purchase Price:</b>" . $row2['pi_price'] . ", <b>Qty:</b>" . $row2['pi_quantity'] . ", <b>Total:</b>" . $row2['pi_total'] . "<br/>";
														$n++;
													}
													?>
                                                   </td>
