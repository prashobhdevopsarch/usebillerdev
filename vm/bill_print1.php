  ...
  <tr >
    <td ><b><span style="font-size:17px;"><?=$row3['sp_shopname']?></span></b><br>
     <span class="s3" ><?=$row3["sp_shopaddress"]?><br>
            <span class="s4" ><?=$row3["sp_phone"]?> &nbsp;<?=$row3["sp_mobile"]?><br>
			GSTIN : <?=$row3["sp_tin"]?>
     </td>  
  </tr>
...
<table width="100%" border="0" style="border-bottom: 0px #808080 solid;">
   ...
   <tr>
    <td><span class="s3"> Date:<?=date('d-m-Y h:i', strtotime($row["be_billdate"]))?></td></tr>
	<tr>
    <td><span class="s3"> Inv No.: <?=$row["be_billid"]-45757?></td></tr>
    <tr><td style="text-align:right"><h1> TOKEN NO. :<?=$row["be_tno"]?></h1></td>
  </tr>
...
<th style="display:none;" width="100px" style bgcolor="#999999"><span class="s3" > ITEMS</th>

<th><span class="s4">ITEMS </th>
<th style="display:none;"  width="100px" >UNIT</th>
<th  width="10%"  ><span class="s4"> MRP&nbsp;</th>

<th   width="25%" ><span class="s4">  QTY&nbsp;&nbsp;</th>

<th   width="25%" ><span class="s4">  RATE </th>
</tr>
<?php
$i=1;
...
<table width="100%" style="font-size: 12px; border-bottom: 1px #808080 solid;">
  <!--<tr>
<td style="text-align:center"><H2> TOKEN NO. :<?=$row["be_billnumber"]?></H2></td><td style="text-align:right"></td>
</tr>-->
<TR>
  <td colspan="4" align="center"><span class="s3"><h3><b>GRANT TOTAL: </b></h3></td>
 <td align="center"><span class="s3"><b><h2><?=$row["be_gtotal"]?></h2></b></td>
 </tr>
<tr>
