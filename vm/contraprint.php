...
<?php if(isset($_GET["back"])){?><a href="<?= $_GET["back"]?>"><button style="float:left;" class="printButtonClass">back</button></a><?php }else{?><a href="contra.php"><button style="float:left;" class="printButtonClass">back</button></a><?php }?>
<?php 
session_start();
...
<table style="text-align:left;" width=100% border="1">
    ...
    <th style="text-align:center; font-size:24px; border-left:hidden; border-right:hidden; border-top:hidden;" colspan="2">CONTRA</th>
