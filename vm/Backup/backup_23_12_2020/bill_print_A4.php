...
<table  style="width:100%;" align="absmiddle"  border="1">
   ...
   <!-- <th style="width:150px;"></th><th><span>INVOICE</span></th><br>-->
	...
	<br>
        ...
        <span><b><h2><?=$row3["sp_shopname"]?></h2></b><br>
...
<th rowspan="2" bgcolor="#999999" align="center">Name of Product</th>
<th rowspan="2" style="width:75px;" bgcolor="#999999">HSN Code</th>
    <th rowspan="2" style="width:75px;" bgcolor="#999999">MRP</th>
...
$am= $disc+$row6['bi_taxamount'];?>
   ...
   <!-- <td style="display:none;"><?php echo $row6['pr_productcode'];?></td>-->
    ...
    <td><span class="s8"><?php echo $row6['bi_mrp1'];?></span></td>
     <td><span class="s8"><?php echo $row6['bi_vatper'];?></span></td>
	 <td><span class="s8"><?php echo $row6['bi_quantity']; echo $row6['pr_unit'];?></span></td>
...
while($k<=15)
{?>
<tr><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td></tr>
<?php $k++;}?>
