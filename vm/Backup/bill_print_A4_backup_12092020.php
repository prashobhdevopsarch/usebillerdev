...
.border td{border-left:1px solid white;border-bottom:1px solid #FFF ;}
@media print{
...
?>
  ...
  <div class="center">
	<th   align="center" colspan="3" ><!--<span style="font-family:'Times New Roman', Times, serif">--><!--<span class="eras" style="font-family:forte;">-->
        ...
        <span><b><h5><?=$row3["sp_shopname"]?></h5></b><br>
        <?=$row3["sp_shopaddress"]?> <br>         
           <?=$row3["sp_email"]?><br>
            <?php $stcode_s=$row3["sp_stcode"];?>
        GSTIN:<?=$row3["sp_tin"]?>
        Ph: <?=$row3["sp_phone"]?>Mob:<?=$row3["sp_mobile"]?></span><br>
			<h4>Bill Receipt (credit)</h4>
  </th>
 </div>
...
<table border="0" width="100%"  class="table">
    ...
    <tr><div class="right">
    <b>Bill Date: <?php $dt=date('d-m-y',strtotime($row4["be_billdate"]));echo $dt?></b>
    	<td  style="padding:1px; border-left:1px solid white; border-right:1px solid white;font-size: 14px;"> <?php if ($row4["be_customerid"] == "0") {
            ?><br></div>
          
           
        Name & Address : 
         <b><?php
		echo $row4["be_customername"]."  ".$row5["cs_address"]; ?></b>
		<br>
		  
        
        
       CUST.GSTIN:  <b><?php echo $row4["be_customer_tin_num"]."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Tel No. :".$row4["be_customermobile"]; echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Sales person:&nbsp&nbsp"  .$row4["be_saleperson"];
		echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEmail : ";
	   } 		
		else {?></b>
            <b>Bill Number:  <?=$row4["be_billnumber"]?>(<?php $d=date('d-m',strtotime($row4["be_billdate"]));echo $d;?>)</b><br>
       Name & Address : 
        <b><?php
...
<div style="border: 3px solid white; margin-bottom:5px;" class="border">
<table width="100%" class="fnt" style="border:1px; border-color: white; solid white;">
<tr style="border:1px; solid white; border-color: white;">
    <u><th rowspan="2" style="width:10px; border-color: white; " bgcolor="white"><u> S#</u></th></u>
<!--<th rowspan="2" bgcolor="white" style="width:50px;">Code</th>-->
<th rowspan="2" bgcolor="white" style="border-color: white; "  align="center"><u>Particulars</u></th>
<th rowspan="2" style="width:75px; border-color: white;"   bgcolor="white"><u>HSN</u></th>
<th rowspan="2" style="width:50px; border-color: white;"  bgcolor="white"><u>Unit</u></th>
<th rowspan="2" style="width:50px; border-color: white;"   bgcolor="white"><u>Qty</u></th>
<th rowspan="2" style="width:50px; border-color: white;"   bgcolor="white"><u>Rate</u></th>
    
   <!-- <th rowspan="2" style="width:30px; border-color: white;"   bgcolor="white"><u>Discount</u></th>-->
    <th rowspan="2" style="width:50px;border-color: white;"   bgcolor="white"><u>AMOUNT</u></th>
...
$am= $disc+$row6['bi_taxamount'];?>
	<td style="border-color: white; "><span class="s8"><?php echo $k;?></span></td>
   <!-- <td style="display:none;"><?php echo $row6['pr_productcode'];?></td>-->
    <td align="center" style="width:35%; font-size: 14px; border-color: white; "><span class="s8"><?php  echo $row6["pr_productname"];?></span></td>
    <td style="border-color: white; "><span class="s8"><?php echo $row6['pr_hsn'];?></span></td>
     <td style="border-color: white; "><span class="s8"><?php echo $row6['pr_unit'];?></span></td>
	 <td style="border-color: white; "><span class="s8"><?php echo $row6['bi_quantity'];?></span></td>
       <td style="border-color: white; "><span class="s8"><?php if($row6['bi_quantity']!=0) { echo $gk2=number_format(($row6['bi_taxamount']+$row6['bi_disc'])/$row6['bi_quantity'],2); } else { echo 0;}?></span></td>
   <!-- <td style="border-color: white; "><span class="s8"><?php echo $gk2*$row6['bi_quantity']; ?></span></td>-->
   <!-- <td style="border-color: white; "><span class="s8"><?php echo round($disc,2);?></span></td>-->
    <td style="border-color: white; "><span class="s8"><?php echo $row6['bi_taxamount'];?></span></td> 
...
$totalbi1=$totalbi1+$row6['bi_total'];?>
<?php $k++; }
while($k<=11)
{?>
<tr style="border-color: white; "><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td></tr>
<?php $k++;}?>
<tr style="border-top: 2px solid white; border-bottom: 2px solid white;">
	<td></td>
    <td style="text-align:right; border-color: white;">Total:</td>
   <td style="border-color: white; "></td><td style="border-color: white; "></td>
   <td align="center" style="border-color: white; "><?php echo $qt;?></td>
    
 
    <td style="border-color: white; "></td>
      
    
<td align="center" style="border-color: white; "><?php echo $amt;?></td>   
</tr>
</table>
<?php if($r==$ttl){?>
...
<table width="100%">
<tr>
<td colspan="5" style="border-bottom:1px border-color: white; ">
...
<tr>
<td></td>
<td style="border-bottom:1px solid white;" colspan="3">
...
<td style="border-bottom:1px solid white;" colspan="3"><?php $slctsgst5t=$conn->query("select sum(bi_cgst_amt) as 5tax from us_billitems where bi_billid='$billid'"); $rowitm5t=$slctsgst5t->fetch_assoc();
...
<span class="s8">Cash received</span>
</td>
<td style="border-bottom:1px solid white;" colspan="3">
    ...
    <td></td>
        <td style="border-bottom:1px solid white;" colspan="3">
<span class="s8">Credit Amount</span>
</td>
<td style="border-bottom:1px solid white;" colspan="3">
...
<tr>
<td>Total credits: <?=$row4["be_oldbal"]?></td>
<td style="border-bottom:1px solid white;" colspan="3">

<b>
<span class="s8">Grand Total</span></b>
</td>
<td style="border-bottom:1px solid white;" colspan="3">
<span class="s8">
<b><?= round($totalbi1+$row4["be_coolie"]);?></b>
</span>
</td>
</tr>
...
<tr>
<td colspan="1" style="border-bottom:1px solid white;" width="40%"><span class="s2">
...
<tr style="height:30px;">
 ...
 <div class="center">
     <footer><h4> THANK YOU VISIT AGAIN</h4></footer></div>
<?php 
$j=0;
$j=$j+15;
while($cnt1>$j)
...
<table  width="100%" border="1">
  ...
  <tr border="1" >
    <td rowspan="3" style="padding:5px;width:75%; border-left:1px solid white;text-align: center;">SALES INVOICE - LOCAL(Wholesale)</td>
    <td style="padding:5px;width:50%; border-left:1px solid white;font-size: 10px;">Original For Recipient</td>
    
  </tr>
  <tr border="1" >
    <td style="padding:5px; border-left:1px solid white;font-size: 10px;">Duplicate For Suppier/Transporter</td>
    
    
  </tr>
  <tr border="1" >
    <td style="padding:5px; border-left:1px solid white;font-size: 10px;">Triplicate For Supplier</td>
...
<table style="text-align: left; border-color:white;" width="100%" border="1">
   <tr border="1" >
    <td  style="padding:5px;width:50%; border-left:1px solid white;">
    ...
    <td  style="padding:5px;width:50%; border-left:1px solid white">Transportation Mode:<br>
...
<table border="1" width="100%" class="table">
    <tr>
        <td style="text-align:center;width: 50%; border-left:1px solid white;">Details Of Reciever (Billed To)</td>
        <td style="text-align:center;width: 50%; border-left:1px solid white;">Details Of Consignee</td>
    </tr>
    <tr>
   
        <td style="padding:5px; border-left:1px solid white;"> <?php if ($row4["be_customerid"] == "0") {
        ?>
        Name:
        <b><?php
        ...
        CUST.GSTIN:  <b><?php echo $row4["be_customer_tin_num"];
        } 
...
?>
<div style="border: 1px white solid;margin-bottom:5px;" class="border">
<table width="100%" class="fnt" style="border:1px solid white;">
<tr>
<th rowspan="2" style="width:10px;" bgcolor="white;"> S#</th>
<!--<th rowspan="2" bgcolor="white" style="width:50px;">Code</th>-->
<th rowspan="2" bgcolor="white" align="left">Particulars/Service</th>
<th rowspan="2" style="width:75px;" bgcolor="white;">HSN<br>ACS</th>
<th rowspan="2" style="width:50px;" bgcolor="white;">Qty</th>
<th rowspan="2" style="width:50px;" bgcolor="white;">UOM</th>
<th rowspan="2" style="width:50px;" bgcolor="white;">Unit Rate</th>
<th rowspan="2" style="width:50px;" bgcolor="white;">Amount</th>
<th rowspan="2" style="width:30px;" bgcolor="white;">Less<br>Disc</th>
<th rowspan="2" style="width:50px;" bgcolor="white;">Taxable Values</th>
<?php if($stcode_c==$stcode_s)
{?>


<th colspan="2"  style="width:60px;" bgcolor="white;">CGST</th>
<th  colspan="2" style="width:60px;" bgcolor="white;">SGST</th>
<?php }

else{
?>
<th colspan="2"  style="width:60px;" bgcolor="white">IGST</th>
<?php }?>

<th rowspan="2" style="width:50px;" bgcolor="white">Total</th>
...
<tr><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td><td style="border-right:1px solid white;">&nbsp;</td></tr>
<?php $k++;}?>
<tr style="border-top: 2px white solid;border-bottom: 2px white solid">
    <td></td>
...
<table width="100%">
<tr>
<td colspan="2" style="border-bottom:1px solid white;" rowspan="4">
...
<td style="border-bottom:1px solid white;" colspan="2">
...
<tr>
<td colspan="2" rowspan="4" style="border-bottom:1px solid white;">
...
<tr>
<td style="border-bottom:1px solid white;" colspan="2">Other Charges</td><td style="border-bottom:1px solid white;" colspan="2"><?=$row4["be_coolie"]?></td>
</tr>

<tr>
<td style="border-bottom:1px solid white;" colspan="2"><b>Invoice Total(Rs) </b></td><td style="border-bottom:1px solid white;" colspan="2"><b><?= round($totalbi2+$row4["be_coolie"]);?></b></td>
</tr>
<?php
...
?>
<tr>
<td style="border-bottom:1px solid white;" colspan="2"><b> Grand Total(Rs)</b></td>
<td style="border-bottom:1px solid white;" colspan="2"><b><?=$grndtot;?></b></td>
</tr>

<tr>
<td colspan="1" style="border-bottom:1px solid white;" width="40%"><span class="s2"><b>Terms & Conditions:</b><br>
Goods once sold will not taken back or exchanged<br>
</span></td>

<td style="border-bottom:1px solid white; text-align:center;" width="30%" align="center"><br><br>(Common seal)</td>
<td style="border-bottom:1px solid white;" ><span class="s3">Certified that the given above are true and correct</span><br>
...
<footer><h5 text-align:"center;"> THANK YOU VISIT AGAIN </h5></footer>
<?php
}$j=$j+20;}
