...
<table  style="width:100%;" align="left"  border="1">
   ...
   <!-- <th style="width:150px;"></th><th><span>INVOICE</span></th><br>-->
	...
	<th   align="left" width="80%" colspan="3" ><!--<span style="font-family:'Times New Roman', Times, serif">--><!--<span class="eras" style="font-family:forte;">-->
	<b style="float:right"><?=$row3["sp_mobile"]?></b><br>
	<b><span class="s1"><?=$row3["sp_shopname"]?></span></b><br>
 			<?=$row3["sp_shopaddress"]?><br> 
       <b> ph:<?=$row3["sp_mobile"]?></b><br>
            <?=$row3["sp_email"]?><br>
...
________________________________________________<br>
    ...
    To
    <b><?=$row5["cs_customername"]; ?><?=$row4["be_customername"]; ?></b>
     <br>
    <b>    
        <?=$row5["cs_address"]; ?><?=$row4["be_address"]; ?></b>
		<br>
    <b>Customer GSTIN:<?=$row5["cs_tin_number"]; ?><?=$row4["be_customer_tin_num"]; ?><br>
       Tel No. :<?=$row4["be_customermobile"]; ?><?=$row5["cs_customerphone"]; ?><br>
			<?=$row5["cs_email"];?>
    
    <td  style="border-left:1px solid #000;" colspan="3"> <b>Invoice NO:  <?=$row4["be_billnumber"]?>(<?php $d=date('d-m',strtotime($row4["be_billdate"]));echo $d;?>)</b>
...
Terms and Delivery:
    ...
    <td  style="border-left:1px solid #000;" colspan="3"> <b>Dated: <?=$row4["be_billdate"]?></b><br>
...
Buyer's order no <br>       
 ...
 <tr>
<td colspan="8" style="border-side:4px solid #000;" width="40%">
Our DC No Date...............................P.O. No & Date......................................
</td>
...
<tr>
<th rowspan="1" style="width:1px;" bgcolor="#999999"> S#</th>
    <th rowspan="2" style="width:30px;" bgcolor="#999999">HSN Code</th>
<!--<th rowspan="2" bgcolor="#999999" style="width:50px;">Code</th>-->
<th rowspan="2" bgcolor="#999999" align="center">Particulars</th>

    <!--<th rowspan="2" style="width:40px;" bgcolor="#999999">GST Rate</th>-->
    <!--<th rowspan="2" style="width:30px;" bgcolor="#999999">KFC%</th>-->
<!--<th rowspan="2" style="width:50px;" bgcolor="#999999">Unit</th>-->
<th rowspan="2" style="width:50px;" bgcolor="#999999">Qty</th>
<th rowspan="2" style="width:50px;" bgcolor="#999999">Rate After Tax</th>
<!--<th rowspan="2" style="width:50px;" bgcolor="#999999">Amount</th>
<th rowspan="2" style="width:30px;" bgcolor="#999999">Dis%</th>-->
    
<th rowspan="2" style="width:100px;" bgcolor="#999999">Amount</th>
...
$am= $disc+$row6['bi_taxamount'];?>
   ...
   <td><span class="s8"><?php echo $row6['pr_hsn'];?></span></td>
    <td align="left" style="width:40%; font-size: 14px;"><span class="s8"><?php  echo $row6["pr_productname"];?></span><br>
    
    </td>
   
    <!--<td><span class="s8"><?php echo $row6['bi_vatper'];?>%</span></td>-->
   <!-- <td><span class="s8"><?php echo $row6['bi_cess'];?>%</span></td>-->
     <!--<td><span class="s8"><?php echo $row6['pr_unit'];?></span></td>-->
	 <td><span class="s8"><?php echo $row6['bi_quantity'];?> NOS</span></td>
...
while($k<=15)
{?>
<tr> <td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td><td style="border-right:1px solid #808080;">&nbsp;</td></tr>
<?php $k++;}?>
...
<tr>
    <td colspan="1" style="border-bottom:2px solid #000;" width="40%">
Transport Vehicle No. : <?=$row4["be_vehicle_number"]?><br>
    100% Advance : <?=$row4["be_hunad"]?><br>
     Shipping Address : <?=$row4["be_shipping"]?><br>
    Customer Balance : <?=$row4["be_customerbalance"]?><br>
    
    <b><u>BANK Detail</u></b>  <br>
    Bank Name:<?=$row3["sp_bank"]?><br>
Account No:<?=$row3["sp_accno"]?><br>
IFSC Code:<?=$row3["sp_ifsc"]?>&nbsp;&nbsp;Branch:<?=$row3["sp_branch"]?><br>
_________________________________________<br>
    <span class="s8">Rupees in words: <br><b> <?php $amd=convertToIndianCurrency(round($totalbi1));echo $amd;?> </b> </span><br><br><br>
<br><br></td>
<td colspan="1" style="border-bottom:2px solid #000;"  width="25%"><span class="s2"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    <b><h4 text-align: center;>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Customer Seal & Sign</h4></b>
</span></td>


<td style="border-bottom:1px solid #000;" ><span class="s3"></span><br>
<br><br><br><br>
...
<!--<th rowspan="2" bgcolor="#999999" style="width:50px;">Code</th>-->
<th rowspan="2" bgcolor="#999999" align="left">Description of goods/Service</th>
