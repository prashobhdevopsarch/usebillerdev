...
<table  style="width:100%;" align="absmiddle"  border="1">
   ...
   <!-- <th style="width:150px;"></th><th><span>INVOICE</span></th><br>-->
	   ...
	   <th width="30%" style="border-right:0px;"><!--<span style="font-family:'Times New Roman', Times, serif">--><!--<span class="eras" style="font-family:forte;">-->
	     <br>
      <img src="image/Gklogo1.png"  style="float:left;"  width="50%" height="auto" >
    </th>
    <th style="text-align: center; border-right:0px; border-left: 0px;">
      <b> <p style="color:red; font-size: 20px;"><?=$row3["sp_shopname"]?></p></b>
      <br/>
      
      <span style="text-decoration: underline;">Triplicate</span>
    </th>
    <th style="text-align: right; border-left:0px;" width="30%">
      <p><b><?=$row3["sp_shopaddress"]?></b> <br>       
           Email:<?=$row3["sp_email"]?><br>
            <?php $stcode_s=$row3["sp_stcode"];?>
        GSTIN:<?=$row3["sp_tin"]?><br>
       Ph: <?=$row3["sp_phone"]?>Mob:<?=$row3["sp_mobile"]?><br></p></p>
    </th>
