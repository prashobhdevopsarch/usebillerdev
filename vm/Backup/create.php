...
if(isset($_POST["selectall"]))
{
	...
	{
	?>
	<td style="text-align:center;"><b><?php echo $row3['sp_shopname']?></b><br><b>ITEM :<?php echo $rpw_pr['pr_productname']?></b><br><b>PRICE :<?php echo $rpw_pr['pr_saleprice']?></b><br><img width="100%" src="barcode.php?text=<?= $rpw_pr['pr_productcode'] ?>" alt="testing" /><br><b>CODE :<?php echo $rpw_pr['pr_productcode']?></b></td>
