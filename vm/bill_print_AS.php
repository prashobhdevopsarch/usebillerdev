...
{
	$billid=$_GET["billid"];
	$slct=$conn->query("SELECT * FROM us_seritem WHERE se_billid='$billid'");
	$row=$slct->fetch_assoc();
	
	$cnt=$conn->query("SELECT COUNT(se_billitemid) AS cnt FROM us_seritem WHERE se_billid='$billid'");
...
$bill = $conn->query("SELECT * FROM us_ser WHERE se_billid='$billid'");
$row4=$bill->fetch_assoc();
$cust= $conn->query("SELECT * FROM us_customer WHERE cs_customerid='".$row4["se_customerid"]."'");
...
<table  style="width:100%;"  border="1">
   ...
   <!-- <th style="width:150px;"></th><th><span>INVOICE</span></th><br>-->
	...
	<!--<span style="font-family:'Times New Roman', Times, serif">--><!--<span class="eras" style="font-family:forte;">-->
	<h4 style="text-align:center;">
        <b><span style="text-align:center; border-right: 0px; border-left: 0px;"><?=$row3["sp_shopname"]?><br></span>
 		<span>	<?=$row3["sp_shopaddress"]?><br>           
            <?=$row3["sp_email"]?>
        <?php $stcose_s=$row3["sp_stcode"];?><br></b></span>
    
			<span><u>Service Bill</u></h4></span>
    
        
  
   Bill NO:<?=$row4["se_billid"]?> 
  </tr>
...
<table width="100%" class="fnt" style="border:1px solid #808080;">
  <tr>   <th></th><th style="text-align:left;">Customer name :  <?=$row4["se_customername"]?> <br>Phone: <?=$row4["se_customermobile"]?> </th><th></th>
  <th  style="text-align:left;width:100px;">date: <?=$row4["se_deliverydate"]?> <br> Place: <?=$row4["se_address"]?></th></tr>
<tr>
    
<th rowspan="2" style="width:10px;" bgcolor="#999999">S#</th>

<!--<th rowspan="2" bgcolor="#999999" style="width:50px;">Code</th>-->
<th rowspan="2" bgcolor="#999999" align="left">ITEM NAME</th>

<th rowspan="2" style="width:50px;" bgcolor="#999999">COMPLAINT</th>
...
<?php $disc= $row6['se_disc'];




$am= $disc+$row6['se_taxamount'];
    $amt3=$amt3+$row6['se_price1'];  ?>
	<td><span class="s8"><?php echo $k;?></span></td>
   <!-- <td style="display:none;"><?php echo $row6['pr_productcode'];?></td>-->
    <td align="left" style="width:35%; font-size: 14px;"><span class="s8"><?php  echo $row6["se_item"];?></span></td>
    
     <td><span class="s8"><?php echo $row6['se_com'];?></span></td>
	 <td><span class="s8"><?php echo $row6['se_price1'];?></span></td>
...
{
	$r++;	
$slctitm1=$conn->query("SELECT * FROM us_deitem a LEFT JOIN us_products b ON b.pr_productid=a.se_productid WHERE a.se_billid='$billid' LIMIT ".$j.",15");
...
<table  style="width:100%;" align="absmiddle"  border="1">
   ...
   <!-- <th style="width:150px;"></th><th><span>INVOICE</span></th><br>-->
    ...
    <th   align="center" colspan="3" ><!--<span style="font-family:'Times New Roman', Times, serif">--><!--<span class="eras" style="font-family:forte;">--><b><span class="s1"><?=$row3["sp_shopname"]?></span></b><br>
     ...
     Shipping Address : <?=$row4["se_shipping"]?>

            <?=$row3["sp_email"]?></span>
            <?php $stcose_s=$row3["sp_stcode"];?>
...
<table style="text-align: left; border-color:#000;" width="100%" border="1">
   <tr border="1" >
    <td  style="padding:5px;width:50%; border-left:1px solid #000;">
                    ...
                    Invoice Serial Number:  <b><?=$row4["se_billnumber"]?>(<?php $d=date('d-m',strtotime($row4["se_billdate"]));echo $d;?>)</b><br>
                    Invoice Date: <?php $dt=date('d-m-y',strtotime($row4["se_billdate"]));echo $dt?><br>
    ...
    <td  style="padding:5px;width:50%; border-left:1px solid #000">Transportation Mode:<br>
                    Vehicle Number: <?=$row4["se_vehicle_number"]?><br>
                    Date And Time Of Supply:<?php $dt=date('d-m-y',strtotime($row4["se_billdate"]));echo $dt?><br>
                    Place Of Supply: <b><?php if ($row4["se_customerid"] == "0") { 
                         if($row4["se_statecode"]=="AN"){echo "Andaman and Nicobar Islands ";}
                         elseif($row4["se_statecode"]=="AP"){echo "Andhra Pradesh";}
                         elseif($row4["se_statecode"]=="AD"){echo "Andhra Pradesh";}                                                                                         elseif($row4["se_statecode"]=="AR"){echo "Arunachal Pradesh";}
                         elseif($row4["se_statecode"]=="AS"){echo "Assam";}
                         elseif($row4["se_statecode"]=="BH"){echo "Bihar";}
                         elseif($row4["se_statecode"]=="CH"){echo "Chandigarh";}
                         elseif($row4["se_statecode"]=="CT"){echo "Chattisgarh";}
                         elseif($row4["se_statecode"]=="DN"){echo "Dadra and Nagar Haveli";}
                         elseif($row4["se_statecode"]=="DD"){echo "Daman and Diu";}
                         elseif($row4["se_statecode"]=="DL"){echo "Delhi";}
                         elseif($row4["se_statecode"]=="GA"){echo "GoA";}
                         elseif($row4["se_statecode"]=="GJ"){echo "Gujarat";}
                         elseif($row4["se_statecode"]=="HR"){echo "Hariyana";}                           
                         elseif($row4["se_statecode"]=="HP"){echo "Himachal Pradesh";}
                         elseif($row4["se_statecode"]=="JK"){echo "Jammu And Kashmir";}
                         elseif($row4["se_statecode"]=="JH"){echo "Jharkhand";}
                         elseif($row4["se_statecode"]=="KA"){echo "Karnataka";}
                         elseif($row4["se_statecode"]=="KL"){echo "Kerala";}
                         elseif($row4["se_statecode"]=="LD"){echo "LakshadWeep Island";}
                         elseif($row4["se_statecode"]=="MP"){echo "Madhya Pradhesh";}
                         elseif($row4["se_statecode"]=="MH"){echo "Maharastra";}
                         elseif($row4["se_statecode"]=="MN"){echo "Manipur";}
                         elseif($row4["se_statecode"]=="ME"){echo "Meghalaya";}
                         elseif($row4["se_statecode"]=="MI"){echo "Mizoram";}                           
                         elseif($row4["se_statecode"]=="NL"){echo "Nagaland";}
                         elseif($row4["se_statecode"]=="OR"){echo "Odisha";}
                         elseif($row4["se_statecode"]=="PY"){echo "Pondicherry";}
                         elseif($row4["se_statecode"]=="PB"){echo "Punjab";}
                         elseif($row4["se_statecode"]=="RJ"){echo "Rajasthan";}                           
                         elseif($row4["se_statecode"]=="SK"){echo "Sikkim";}
                         elseif($row4["se_statecode"]=="TN"){echo "Tamil Nadu";}
                         elseif($row4["se_statecode"]=="TS"){echo "Telangana";}
                         elseif($row4["se_statecode"]=="TR"){echo "Tripura";}
                         elseif($row4["se_statecode"]=="UP"){echo "Uttar Pradesh";}
                         elseif($row4["se_statecode"]=="UI"){echo "Uttarakhand";}
                         elseif($row4["se_statecode"]=="WB"){echo "West Bengal";}
                         else {echo "Kerala";}}
                    else{
...
<table border="1" width="100%" class="table">
    ...
    <tr>
        ...
        <td style="padding:5px; border-left:1px solid #000;"> <?php if ($row4["se_customerid"] == "0") {
        ?>
        Name:
        <b><?php
        echo $row4["se_customername"];?></b>
        <br>Ph:
        <b><?php
        echo $row4["se_customermobile"]; 
        ?></b>
        <br>State: <b><?php if($row4["se_statecode"]=="AN"){echo "Andaman and Nicobar Islands ";}
                         elseif($row4["se_statecode"]=="AP"){echo "Andhra Pradesh";}
                         elseif($row4["se_statecode"]=="AD"){echo "Andhra Pradesh";}                                                                                         elseif($row4["se_statecode"]=="AR"){echo "Arunachal Pradesh";}
                         elseif($row4["se_statecode"]=="AS"){echo "Assam";}
                         elseif($row4["se_statecode"]=="BH"){echo "Bihar";}
        ...
        <br>State Code:<b><?php if($row4["se_statecode"]==''){echo"32";$stcose_c='KL';}else{$stcose_c=$row4["se_statecode"];switch($row4["se_statecode"])
        {
        ...
        GST Number:  <b><?php echo $row4["se_customer_tin_num"];
        } 
        else {?></b>
        Name:
        <b><?php
        ...
        <br>State Code:<b><?php if($row4["se_statecode"]==''){$stcose_c='KL';echo"32";}else{$stcose_c=$row4["se_statecode"];switch($row4["se_statecode"])
        {
            case 'AN':echo "35";break;
            case 'AP':echo "28";break;
            case 'AD':echo "37";break;
        ...
        else {$cust= $conn->query("SELECT * FROM us_customer WHERE cs_customerid='".$row4["se_customerid"]."'");
        ...
        ?></b>
         ...
         <br>
        State Code: <b><?php //echo $row5["cs_statecode"];
        $row4["se_statecode"]=$row5["cs_statecode"];
        switch($row5["cs_statecode"])
        {
            case 'AN':echo "35";break;
            case 'AP':echo "28";break;
...
$gk2=0;
$tot=0;
$bill2=$conn->query("SELECT * FROM us_deitem a LEFT JOIN us_products b ON b.pr_productid=a.se_productid WHERE a.se_billid='$billid' LIMIT ".$j.",20");
...
$am= $disc+$row6['se_taxamount'];?>
   ...
   <!-- <td style="display:none;"><?php echo $row6['pr_productcode'];?></td>-->
    ...
    <td><span class="s8"><?php echo $row6['pr_hsn'];?></span></td>
     <td><span class="s8"><?php echo $row6['se_quantity'];?></span></td>
<td><span class="s8"><?php echo $row6['pr_unit'];?></span></td>

      <td><span class="s8"><?php if($row6['se_quantity']!=0) { echo $gk2=number_format(($row6['se_taxamount']+$row6['se_disc'])/$row6['se_quantity'],2); } else { echo 0;}?></span></td>
    <td><span class="s8"><?php echo $gk2*$row6['se_quantity']; ?></span></td>
    <td><span class="s8"><?php echo round($disc,2);?></span></td>
    <td><span class="s8"><?php echo $row6['se_taxamount'];?></span></td>
   
    <?php if($stcose_c==$stcose_s)
    {?>
    <td class="s8"><?php echo $row6['se_cgst'];?></td>
    <td class="s8"><?php $tcgst=$tcgst+round($row6['se_cgst_amt']);echo ($row6['se_cgst_amt']);?></td>
    <td class="s8"><?php echo $row6['se_sgst'];?></td>
    <td class="s8"><?php $tsgst=$tsgst+round($row6['se_sgst_amt']);echo ($row6['se_sgst_amt']);?></td>
    <?php }else{?>
    <td class="s8"><?php echo $row6['se_igst'];?></td>
    <td class="s8"><?php $tigst=$tigst+round($row6['se_igst_amt']);echo ($row6['se_igst_amt']);?></td>
    <?php }?>
<td><span class="s8"><?php echo $row6['se_total'];?></span></td>
   
    
</tr>
<?php $qt=$qt+$row6['se_quantity'];
$amt=$amt+$row6['se_taxamount'];
$dis=$dis+$disc;
$tax=$tax+round($row6['se_taxamount']);
$totalbi2=$totalbi2+$row6['se_total'];?>
<?php $k++; }
while($k<=$j+9)
{?>
...
<?php $slctsgst=$conn->query("select sum(se_cgst_amt) as cgs,sum(se_sgst_amt) as sgs,sum(se_igst_amt) as igs  from us_deitem where se_billid='$billid'"); $rowi=$slctsgst->fetch_assoc();
...
<td style="border-bottom:1px solid #000;" colspan="2">
<span class="s8"><?php $slctsgst5t=$conn->query("select sum(se_cgst_amt) as 5tax from us_deitem where se_billid='$billid'"); $rowitm5t=$slctsgst5t->fetch_assoc();
...
<td style="border-bottom:1px solid #000;" colspan="2">
<span class="s8"><?php $slctsgst6t=$conn->query("select sum(se_sgst_amt) as 6tax from us_deitem where se_billid='$billid'"); $rowitm6t=$slctsgst6t->fetch_assoc();
...
<td style="border-bottom:1px solid #000;" colspan="2">
<span class="s8"><?php $slctsgst7t=$conn->query("select sum(se_igst_amt) as 7tax from us_deitem where se_billid='$billid'"); $rowitm7t=$slctsgst7t->fetch_assoc();
...
<tr>
<td style="border-bottom:1px solid #000;" colspan="2">Other Charges</td><td style="border-bottom:1px solid #000;" colspan="2"><?=$row4["se_coolie"]?></td>
</tr>

<tr>
<td style="border-bottom:1px solid #000;" colspan="2"><b>Invoice Total(Rs) </b></td><td style="border-bottom:1px solid #000;" colspan="2"><b><?= round($totalbi2+$row4["se_coolie"]);?></b></td>
</tr>
<?php
    $billtot = $conn->query("SELECT sum(se_total) as grandtotal FROM us_deitem WHERE se_billid='$billid'");
