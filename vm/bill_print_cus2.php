...
<table style="float:right;text-align:left;" width="200" border="0">
  <tr>
    <th><span class="s5">Date : <?=date('d-m-Y', strtotime($row["bi_billdate"]))?></th>
    
  </tr>
  <tr>
    <th><span class="s5">Bill NO :<?=$row["bi_billnumber"]?></th>
...
<?php if($_GET['csid']!=0)
{
	$slctcust=$conn->query("SELECT * FROM us_customer WHERE cs_customerid='".$_GET['csid']."'");
  ...
  <?php }else{?>
  <tr>
    <th><b><span class="s5"><?=$row["bi_customername"]?></b></th><td></td><td></td>
  </tr>
  <tr>
    <th><span class="s5"><?=$row["bi_customermobile"]?></th><td></td><td></td>
  </tr>
...
$slctitm=$conn->query("SELECT * FROM us_estimationitems a LEFT JOIN us_products b ON b.pr_productid=a.bi_productid WHERE a.bi_billid='$billid'");
...
<?php $i++;}?>
 ...
 <td align="center"><span class="s4"><?=$row["bi_total"]?></td>
 ...
 <td align="center"><span class="s4"><?=$row["bi_discount"]?></td>
</tr>
<!--<tr>
 
 <td colspan="6" align="right"><span class="s4">FREIGHT</td>
 <td align="center"><?=$row["bi_coolie"]?></td>
</tr>
<tr>
 
 <td colspan="6" align="right"><span class="s4">OB</td>
 <td align="center"><?=$row["bi_oldbal"]?></td>
</tr>-->
<tr>
 
 <td colspan="4" align="right">GRAND TOTAL</td>
 <td align="center"><?=$row["bi_gtotal"]?></td>
</tr>
 <!--<tr>
 
 <td colspan="6" align="right"><span class="s4">PAID AMOUNT</td>
 <td align="center"><?=$row["bi_paidamount"]?></td>
</tr>
<tr>
 
 <td colspan="6" align="right"><span class="s4">BALANCE</td>
 <td align="center"><?=$row["bi_balance"]?></td>
</tr>-->
