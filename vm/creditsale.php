...
if(isset($_SESSION['admin']))
{
	...
	if(isset($_GET["delete"]))
	{
		...
		if($delete && $slct)
		{
			...
			{
			header('Location:creditsale.php?id=success');
			}
				
			
			else{header('Location:creditsale.php?id=fail');}
		}else{
		  header('Location:creditsale.php?id=fail');
		}
	}
?>
<!DOCTYPE html>
...
<head>  
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>Credit Sale Reports</strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>Billing</li>
                            <li class="active">Credit Sale Reports</li>
                        </ol>
                    </div>
                </div>
                <?php
                        ...
                        <div class="col-lg-12 col-md-12">
							...
							?>
                                <div class="panel-heading">
                                    ...
                                    <h4 class="panel-title">Credit Sale Reports</h4>
                                </div>
                                
                                
                                <div class="panel-body">
                                <form action="creditsale.php" method="post">
								...
								if(isset($_POST['filter']))
											   {
												...
												echo "<h3>ALL CREDIT SALE DETAILS</h3>";
											   }
								?>
                                    <div class="table-responsive project-stats">  
									<a href="cashsale.php" ><button type="button" class="btn btn-primary btn-addon m-b-sm" style="float:left;"><span class=""></span>CASH SALE</button></a><br><br>
	...
	echo $qty = $row2['bi_quantity'];
                                                 ...
                                                 <?php if($row['be_customerid']=='0') {?><a onClick="return confirm('Are you sure you want to delete?')" href="creditsale.php?billid=<?=$row['be_billid']?>&delete"><span class="glyphicon glyphicon-trash"></span> delete</a><?php }?> 
                                                   </td>
                                               </tr>
