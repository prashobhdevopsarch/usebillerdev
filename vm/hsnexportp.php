...
$output .=',HSN Report,';
$output .="\n";
$output .='No.,HSN Code,Product Code,Product Name,Tax,UQC,purchaseprice,KFC,Sales price,Total quantity';
$output .="\n";
...
$output .=$k.','.$row['pr_hsn'].','.$row['pr_productcode'].','.$row['pr_productname'].','.$row['ca_categoryname'].','.$row['pr_unit'].','.$row['pr_purchaseprice'].','.$row['pr_cess'].','.$row['pr_saleprice'].','.$row['pr_stock'].',';
...
$filename = "HSNREPORT".date('d-m-Y H:i').".csv";
