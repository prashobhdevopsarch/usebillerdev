        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>ക്രിയേറ്റ് ബാർകോഡ്</strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>ബില്ലിംഗ് </li>
							<li class="active">ക്രിയേറ്റ് ബാർകോഡ്</li>
               ...
               <?php
				$today = date('Y-m-d');
				$stocks = $conn->query("SELECT * FROM vm_products WHERE user_id='".$_SESSION['admin']."' ORDER BY pr_productcode ASC");
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">എന്റർ  ബാർകോഡ് ഡീറ്റെയിൽസ്</h4>
								...
								if(isset($_GET['id']))
								{
                                    ...
                                    <div class="alert alert-success alert-dismissible" role="alert">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
											ബാർകോഡ് ജനറേറ്റഡ്  സക്‌സെസ്സ്ഫുള്ളി.
                                    </div>
                                    <?php
									}else{?>
                                    <div class="alert alert-danger alert-dismissible" role="alert">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
											ബാർകോഡ് ജനറേറ്റഡ്  ഫെയ്ൽഡ്.
                                    </div>
                                    <?php }
								}
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" method="post" action="create.php">
										...
										<button type="submit" class="btn btn-primary" name="print_bar">പ്രിൻറ് </button>
                                     </form>
