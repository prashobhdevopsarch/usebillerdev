        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>പർച്ചേയ്‌സ് ടാക്‌സ് </strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>ബില്ലിംഗ്</li>
							<li>ടാക്‌സ് റിപ്പോർട്ട്</li>
                            <li class="active">പർച്ചേയ്‌സ് ടാക്‌സ് </li>
                        </ol>
                    </div>
                </div>
                <?php
                        ...
                        <div class="col-lg-12 col-md-12">
							...
							?>
                                <div class="panel-heading">
                                    ...
                                    <h4 class="panel-title">പർച്ചേയ്‌സ് ടാക്‌സ് റിപ്പോർട്ട്</h4>
                                </div>
								...
								if(isset($_POST['filter']))
											   {
												   $fromdate = $_POST['fromdate'];
												   $todate = $_POST['todate'];
												   $bil = $conn->query("SELECT * FROM vm_purentry WHERE DATE(pe_billdate)>='$fromdate' AND DATE(pe_billdate) <= '$todate' AND pe_isactive='0'AND user_id='".$_SESSION["admin"]."' ORDER BY pe_billid DESC");
												   echo "<h3>From Date: ".date('d-M-Y', strtotime($fromdate))." &nbsp; &nbsp; To Date: ".date('d-M-Y', strtotime($todate))."</h3>";
											   }
											   else{
											   	$bil = $conn->query("SELECT * FROM vm_purentry WHERE pe_isactive='0' AND user_id='".$_SESSION["admin"]."' ORDER BY pe_billid DESC");
												echo "<h3>ഓൾ പർച്ചേയ്‌സ് ടാക്‌സ്  ഡീറ്റെയിൽസ്</h3>";
											   }
								?>
                                    <div class="table-responsive project-stats">  
                                       <table id="example" class="display table" style="width: 90%; cellspacing: 0;">
                                           <thead>
                                               <tr>
                                                   <th rowspan="2">#</th>
                                                   <th rowspan="2">ബിൽ നം</th>
                                                   <th rowspan="2">ബിൽ ഡേറ്റ്</th>
												   <th colspan="3" style="text-align:center">ജിഎസ് ടി പർച്ചേയ്‌സ്</th>
                                                   <th colspan="3" style="text-align:center">ജിഎസ് ടി റിട്ടേൺ </th>
