        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>സെയിൽസ് ടാക്‌സ്</strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>ബില്ലിംഗ്</li>
							<li>ടാക്‌സ് റിപ്പോർട്ട് </li>
                            <li class="active">സെയിൽസ് ടാക്‌സ്</li>
                        </ol>
                    </div>
                </div>
                <?php
                        ...
                        <div class="col-lg-12 col-md-12">
							...
							?>
                                <div class="panel-heading">
                                	<a href="exportDB.php?fil=<?= $filt ?>" target="_blank"><button type="button" class="btn btn-primary btn-addon m-b-sm" style="float:right;"><span class="glyphicon glyphicon-print"></span> Print</button></a>
                                    <h4 class="panel-title">സെയിൽസ് ടാക്‌സ് റിപ്പോർട്ട്</h4>
                                </div>
								...
								if(isset($_POST['filter']))
											   {
												...
												echo "<h3>ഓൾ  സെയിൽസ് ടാക്‌സ് ഡീറ്റെയിൽസ്</h3>";
											   }
								?>
                                       ...
                                       <table id="example" class="display table" style="width: 90%; cellspacing: 0;">
                                           <thead>
                                               <tr>
												   ...
												   <th colspan="3" style="text-align:center">ജിഎസ് ടി സെയിൽസ്</th>
                                                   <th colspan="3" style="text-align:center">ജിഎസ് ടി Return</th>
