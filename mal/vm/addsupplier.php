        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>ആഡ് സപ്ലയർ</strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>ബില്ലിംഗ്</li>
							<li>സപ്ലയർ മാനേജ്മെൻറ്</li>
                            <li class="active">ആഡ് സപ്ലയർ</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">ആഡ് സപ്ലയർ ഡീറ്റെയിൽസ്</h4>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="company_name" value="" id="company_name" placeholder="കമ്പനി നെയിം" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-3 control-label">സപ്ലയർ നെയിം</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="supplier_name" value="" id="supplier_name" placeholder="സപ്ലയർ നെയിം" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-help-block" class="col-sm-3 control-label">ഫോൺ നമ്പർ</label>
                                            <div class="col-sm-9">
                                                <input type="text"  class="form-control" name="supplier_phone"  id="supplier_phone" placeholder="ഫോൺ നമ്പർ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="supplier_address" value="" id="supplier_address" placeholder="അഡ്രസ്സ്"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control" name="supplier_email" value="" id="supplier_email" Placeholder="ഇമെയിൽ ഐഡി">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="tect" class="form-control" name="tin_number" value="" id="tin_number" Placeholder="ജിഎസ് ടിൻ">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="balance" value="" id="balance" Placeholder="ബാലൻസ് എമൗണ്ട്">
