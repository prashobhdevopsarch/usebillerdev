...
if(isset($_SESSION['admin']))
{
	...
	if(isset($_POST['submit']))
	{
		...
		//echo print_r($_POST);
		$insert = $conn->query("UPDATE vm_supplier SET rs_company_name='$company_name', rs_name='$supplier_name', rs_phone='$supplier_phone', rs_address='$supplier_address', rs_email='$supplier_email', rs_balance='$balance', rs_tinnum='$tin_number', rs_statecode='$statecode' WHERE rs_supplierid='$supplierid'");
		if($insert)
		{
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>എഡിറ്റ്  സപ്ലയർ</strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>ബില്ലിംഗ്</li>
							<li>സപ്ലയർ മാനേജ്മെൻറ്</li>
                            <li class="active">എഡിറ്റ്  സപ്ലയർ</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">എഡിറ്റ്  സപ്ലയർ ഡീറ്റെയിൽസ്</h4>
								...
								$today = date('Y-m-d');
								$supid=$_GET["supid"];
								$cus = $conn->query("SELECT * FROM vm_supplier WHERE user_id='".$_SESSION["admin"]."' AND rs_supplierid='$supid' AND rs_isactive='0'");
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
                                        ...
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-3 control-label">കമ്പനി നെയിം</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="company_name" value="<?=$row["rs_company_name"]?>" id="company_name" placeholder="കമ്പനി നെയിം" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-3 control-label">സപ്ലയർ നെയിം</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="supplier_name" value="<?=$row["rs_name"]?>" id="supplier_name" placeholder="സപ്ലയർ നെയിം" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-help-block" class="col-sm-3 control-label">ഫോൺ നമ്പർ</label>
                                            <div class="col-sm-9">
                                                <input type="text" pattern="[0-9]{10}" title="Enter valid 10 digit number" value="<?=$row["rs_phone"]?>" class="form-control" name="supplier_phone"  id="supplier_phone" placeholder="ഫോൺ നമ്പർ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="supplier_address" id="supplier_address" placeholder="അഡ്രസ്സ്"><?=$row["rs_address"]?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control" name="supplier_email" value="<?=$row["rs_email"]?>" id="supplier_email" Placeholder="ഇമെയിൽ ഐഡി">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="tect" class="form-control" name="tin_number" value="<?=$row["rs_tinnum"]?>" id="tin_number" Placeholder="ജിഎസ് ടിൻ">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="balance" value="<?=$row["rs_balance"]?>" id="balance" Placeholder="ബാലൻസ് എമൗണ്ട്">
