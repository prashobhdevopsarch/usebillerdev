...
if(isset($_SESSION['admin']))
{
	...
	if(isset($_POST['update']))
	{
		...
		$updte = $conn->query("UPDATE vm_shopprofile SET sp_shopname='$name', sp_shopaddress='$address', sp_phone='$phone', sp_mobile='$mobile', sp_email='$email', sp_vatreadymades='$vat', sp_vatmillgoods='$vat1' WHERE sp_shopid='$shopid'");
		if($updte)
		{
