        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>സ്റ്റോക്‌സ്</strong></h3>
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li>ബില്ലിംഗ്</li>
                            <li class="active">സ്റ്റോക്‌സ്</li>
                        </ol>
                    </div>
                </div>
                <?php
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">സ്റ്റോക്‌സ്</h4>
						   ...
						   <table id="ks-datatable" class="table" width="100%" role="grid" aria-describedby="ks-datatable_info" style="width: 100%;">
                                              ...
                                              <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post" name="updform<?= $k ?>">
                                               ...
                                               <input type="hidden" name="productid" value="<?= $row['pr_productid'] ?>">
												   ...
												   ?>
                                                    ...
                                                    <button type="submit" name="updateprdct" onClick="return confirm('ആർ യു ഷുവർ യു വാണ്ട് റ്റു അപ്ഡേറ്റ്  ?')" style="float: right;" class="btn btn-primary btn-addon  btn-xs"><i class="fa fa-plus"></i> അപ്ഡേറ്റ്  </button><br>
                                                    <a onClick="return confirm('ആർ യു ഷുവർ യു വാണ്ട് റ്റു ഡിലീറ്റ് ?')" href="stocks.php?pid=<?=$row['pr_productid']?>&delete"><button type="button"  style="float: right;" class="btn btn-primary btn-addon  btn-xs"><i class="fa fa-plus"></i> ഡിലീറ്റ് </button></a>
                                                    </td>
                                          ...
                                          <tfoot>
										  <tr>
										  <td colspan="8" align="right"><b>പേജ്  ടോട്ടൽ</b></td>
									   	   <td colspan="3"><?php echo $total; ?></td>
										  </tr>
                                          <tr>
										  <td colspan="8" align="right"><b> ടോട്ടൽ</b></td>
									   	   <td colspan="3"><?php 
										   if(isset($_GET["search"]))
							{
							$key=$_GET["search"];
