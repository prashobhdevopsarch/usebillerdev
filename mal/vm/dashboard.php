        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3><strong>ബില്ലിംഗ് (<?= date('d-M-Y') ?>)</strong></h3>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h4 class="panel-title">ബില്ലിംഗ്</h4>
                                ...
                                <div class="panel-body">
                                    ...
                                    <tbody><?php
                                        ...
                                        <td>
                                        <input type="text" placeholder="ജിഎസ് ടി %" style="width:60px;" class="form-control" name="vatper[]" id="vatper<?= $k ?>"></td>
                                        ...
                                        <input type="text" class="form-control" readonly placeholder="നെറ്റ് എമൗണ്ട്" name="netamnt[]" id="netamnt<?= $k ?>" style="width:100px;"></td>
                                    ...
                                    <table class="table">
                                        ...
                                        <td width="150"><input type="text" readonly class="form-control" name="discount" id="discount" placeholder="ഡിസ്‌കൗണ്ട്" value="0" onKeyUp="calculatedicounttotal(1)" style="width:120px;">
                                        ...
                                        <td width="150"><input type="text" class="form-control" name="paidamount" id="paidamount" onKeyUp="calculatedicounttotal(2)" placeholder="പെയ്ഡ് എമൗണ്ട്" required style="width:120px;">
