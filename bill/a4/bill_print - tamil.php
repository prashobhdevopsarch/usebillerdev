...
<table border="1" width="100%" class="table" >
    ...
    <tr>
       ...
       <br> GSTIN/UIN :  <b><?php echo $row4["be_customer_tin_num"];
        ...
        &nbsp;&nbsp;&nbsp;&nbsp; State Code:<b><?php if($row4["be_statecode"]==''){$stcode_c='TN';echo"33";}else{$stcode_c=$row4["be_statecode"];switch($row4["be_statecode"])
		{
...
<th  width="15%" bgcolor="#999999">HSN CODE</th>
<th  width="10%" bgcolor="#999999">Qty</th>
...
$ig=0;
$tigst=0;
$bill2=$conn->query("SELECT * FROM vm_billitems a LEFT JOIN vm_products b ON b.pr_productid=a.bi_productid WHERE a.bi_billid='$billid' LIMIT 30");
$tot=0;
...
{
	$r++;	
$slctitm1=$conn->query("SELECT * FROM vm_billitems a LEFT JOIN vm_products b ON b.pr_productid=a.bi_productid WHERE a.bi_billid='$billid' LIMIT ".$j.",30");
...
$bill2=$conn->query("SELECT * FROM vm_billitems a LEFT JOIN vm_products b ON b.pr_productid=a.bi_productid WHERE a.bi_billid='$billid' LIMIT ".$j.",30");
