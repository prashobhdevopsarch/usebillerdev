...
if(isset($_GET["billid"]))
{
	...
	$cnt=$conn->query("SELECT COUNT(bi_billitemid) AS cnt FROM vm_estimationitems WHERE bi_billid='$billid'");
...
footer {page-break-after: always;}
	...
	<?php 
$slctid=$conn->query("SELECT COUNT(bi_productid) AS fkk  FROM vm_estimationitems WHERE bi_billid ='".$_GET['billid']."'");
