...
<table style="text-align:center;border-bottom: 0px #808080 solid;" width="100%"  > 
    ...
    <td ><b><span style="font-size:17px;"><?=$row3['sp_shopname']?></span></b><br>
 			<span class="s3" ><?=$row3["sp_shopaddress"]?><br><span class="s3" >GSTIN:<?=$row3["sp_tin"]?><br>
...
?>
 ...
 <td colspan="4" align="right"><span class="s3">TOTAL: &nbsp;</td>
 <td ><span class="s3"><?=$row["be_total"]?></td>
 </tr>
 <tr>
